		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form id="frm" method="post">
					...
					<div class="form-group">
						<label>내용</label> 
						<textarea class="form-control" rows="5" id="board_content" name="board_content"></textarea>
					</div>
					<div class="form-group">
						<label>작성자</label> 
						<input type="text" class="form-control" id="board_writer" name="board_writer" readonly="readonly">
					</div>
