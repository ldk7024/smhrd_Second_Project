...
<body>
			...
			<div class="container">
				...
				<nav class="nav-menu mobile-menu">
					<ul>
						...
						<li><a
							href="http://localhost:8081/kkkko_error/like.jsp?result1=9788950984144&result2=9788950985554&result3=9788950987008&result4=9788950987756&result5=9788950979317&result6=9788950981150&result7=9791196893118&result8=9791196893132&result9=9791196893170&result10=9791195794799">인기
								도서</a>
							<ul class="dropdown">
						...
						<li><a href="#">검색</a>
							<ul class="dropdown">
								<li><a href="./BookSearch.jsp">도서</a></li>
								<li><a href="#">도서관</a></li>
	...
	<section class="hero-section">
		<div class="hero-items owl-carousel">
			<div class="single-hero-items set-bg" data-setbg="img/li.jpg">
				<div class="container">
					<div class="row">
						<div class="col-lg-5">
							<span>Bag,kids</span>
			...
			<div class="single-hero-items set-bg" data-setbg="img/li1.jpg">
				<div class="container">
					<div class="row">
						<div class="col-lg-5">
							<span>Bag,kids</span>
